...
def cts_tasks_training_list(
    ...
    rows = db.execute(text(
        ...
        "            THEN business_minutes_emp(COALESCE(employee_dept_at(edm.id, gt.cts_created_at::date), edm.department), edm.id, gt.cts_created_at, gt.cts_updated_at, ARRAY[]::date[]) "
        ...
        "            THEN business_minutes_emp(COALESCE(employee_dept_at(edm.id, gt.cts_created_at::date), edm.department), edm.id, gt.cts_created_at, gt.cts_in_progress_at, ARRAY[]::date[]) "
        ...
        "                 AND gt.assignee_employee_id IS NOT NULL "
        "            THEN business_minutes_emp(COALESCE(employee_dept_at(edm.id, gt.cts_created_at::date), edm.department), edm.id, gt.cts_in_progress_at, gt.cts_updated_at, ARRAY[]::date[]) "
